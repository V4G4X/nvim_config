return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>dp", function() dap.set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, { desc = "Set Log Point" })
    ...
    vim.keymap.set("n", "<leader>dv", function() require('dap.ui.widgets').preview() end, { desc = "Preview" })
